...
// policy control.
//
// The stable, low-level adapter-facing contract is the top-level
// github.com/tuanuet/lockman/guard package (Context/Outcome only). This
// advanced namespace is for higher-level composition beyond the default client
// flows.
//
...
// github.com/tuanuet/lockman path.
package guard
