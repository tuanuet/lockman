# Strict Sync Fencing Example

This example demonstrates strict single-resource runtime execution using the in-memory driver.
...
```bash
go run ./examples/core/strict-sync-fencing
```
