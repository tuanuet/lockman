...
This example demonstrates strict async worker execution using Redis leases and Redis idempotency state.
...
```bash
LOCKMAN_REDIS_URL=redis://localhost:6379/0 go run -tags lockman_examples ./examples/core/strict-async-fencing
```
